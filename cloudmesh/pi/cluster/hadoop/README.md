...
** This manual is for Hadoop single node set up. For cluster setup, go to
 [here](https://github.com/cloudmesh/cloudmesh-pi-cluster/blob/master/cloudmesh/pi/cluster/hadoop/README_cluster.md) ** 
